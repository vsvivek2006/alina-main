...
export default function GalleryPage() {
  return (
    <>
      <SEO
        title="Gallery | Luxury Companionship Profiles | ALINA VIP"
        description="Browse the ALINA VIP gallery to explore our premium luxury companion categories. Verified profiles, elite companions, and discreet service in Gurgaon."
        keywords="luxury companion gallery Gurgaon, VIP escorts gallery, premium profiles Gurgaon"
        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-charcoal-300 max-w-2xl mx-auto mt-6 leading-relaxed">
              Explore our curated collection of luxury companion categories. Each category represents a unique style of companionship, carefully selected to meet the diverse preferences of our discerning clientele.
            </p>
          </div>
