  ...
  return (
    <>
      <SEO
        ...
        canonical="https://alinavip.com/gallery"
        breadcrumbs={[
          { name: 'Home', url: 'https://alinavip.com' },
          { name: 'Gallery', url: 'https://alinavip.com/gallery' },
        ]}
      />
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <span className="text-gold-400 text-xs font-semibold tracking-wider uppercase flex items-center gap-1">
                          View Call Girls <ArrowRight className="w-4 h-4" />
                        </span>
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Escort Service Available</p>
            </div>
            <div>
          ...
          <div className="text-center mt-6">
            <a href="https://alinavip.com" target="_blank" className="text-gold-400 hover:text-gold-300 text-sm font-semibold">
              Visit ALINAVIP.com
            </a>
          </div>
        </div>
