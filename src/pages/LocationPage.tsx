  ...
  return (
    <>
      <SEO
        ...
        canonical={`https://alinavip.com/locations/${location.slug}`}
        jsonLd={[faqSchema, placeSchema]}
        breadcrumbs={[
          { name: 'Home', url: 'https://alinavip.com' },
          { name: 'Locations', url: 'https://alinavip.com/locations' },
          { name: location.name, url: `https://alinavip.com/locations/${location.slug}` },
        ]}
      />
          ...
          <div className="prose-luxury">
            ...
            <div className="my-8 p-6 bg-gradient-to-r from-gold-50 to-amber-50 rounded-2xl border-2 border-gold-200">
              ...
              <p className="text-center text-sm text-gray-500 mt-2">
                Visit <a href="https://alinavip.com" target="_blank" className="text-gold-600 hover:underline font-semibold">ALINAVIP.com</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-luxury max-w-2xl">
          ...
          <div className="bg-gradient-to-br from-[#1a1a2e] to-[#2d1b0e] p-8 rounded-3xl shadow-2xl border border-gold-500/20">
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Thank you for your booking request. We will contact you shortly.'); }}>
              ...
              <p className="text-center text-xs text-gray-500">Visit <a href="https://alinavip.com" target="_blank" className="text-gold-400 hover:underline font-semibold">ALINAVIP.com</a></p>
            </form>
          </div>
        </div>
      </section>
