        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-charcoal-300 max-w-2xl mx-auto mt-6 leading-relaxed">
              ALINA VIP provides premium escort service across all major areas of Gurgaon and select locations in New Delhi. Select your area below to find <Link to="/call-girls" className="text-gold-400 hover:underline">call girls</Link> and <Link to="/escorts" className="text-gold-400 hover:underline">escorts</Link> near you.
            </p>
          </div>
