...
export default function LocationsPage() {
  return (
    <>
      <SEO
        title="Locations | Luxury Companionship in Gurgaon & Delhi | ALINA VIP"
        ...
        keywords="escorts Gurgaon locations, companionship Gurgaon areas, luxury escorts DLF, escorts Cyber City, escorts MG Road"
        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-charcoal-300 max-w-2xl mx-auto mt-6 leading-relaxed">
              ALINA VIP provides premium luxury companionship services across all major areas of Gurgaon and select locations in New Delhi. Select your area below to learn more about our services in your location.
            </p>
          </div>
