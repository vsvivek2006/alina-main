...
export default function ServicesPage() {
  return (
    <>
      <SEO
        title="Our Services | Luxury Companionship Services in Gurgaon | ALINA VIP"
        description="Explore ALINA VIP's luxury companionship services in Gurgaon. Dinner companions, event companions, travel companions, party companions, and more. Call +91-9996265679."
        keywords="luxury companionship services Gurgaon, dinner companion Gurgaon, travel companion Gurgaon, event companion Gurgaon"
        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-charcoal-300 max-w-2xl mx-auto mt-6 leading-relaxed">
              ALINA VIP offers a comprehensive range of luxury companionship services designed to meet the diverse needs of our discerning clientele. Each service is delivered with the highest standards of quality, discretion, and professionalism.
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            <p className="section-subtitle">Companion Categories</p>
