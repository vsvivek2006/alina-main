...
import { ArrowRight, Phone, Star, Crown, Sparkles, Users, Shield, Clock, MapPin } from 'lucide-react';
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://alinavip.com/services"
        breadcrumbs={[
      ...
      <section className="py-16 bg-[#faf6f2]">
        <div className="container-luxury">
          ...
          <div className="text-center mt-6">
            <a href="https://alinavip.com" target="_blank" className="text-gold-600 hover:text-gold-700 font-semibold">
              Visit ALINAVIP.com
            </a>
          </div>
        </div>
        ...
        <div className="container-luxury">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-2xl border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Every call girl is verified through our rigorous authentication process.</p>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-2xl border border-gray-100">
              <div className="w-14 h-14 bg-gold-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Clock className="w-7 h-7 text-gold-600" />
              </div>
              <h4 className="font-bold text-[#1a1a2e] mb-2">24/7 Escort Service</h4>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-2xl border border-gray-100">
              ...
              <h4 className="font-bold text-[#1a1a2e] mb-2">All Gurgaon Areas</h4>
              <p className="text-sm text-gray-600">We provide <Link to="/services" className="text-gold-600 hover:underline">escort service</Link> across all major locations.</p>
            </div>
          </div>
        </div>
      </section>
