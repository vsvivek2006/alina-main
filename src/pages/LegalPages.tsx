  ...
  return (
    <>
      <SEO
        ...
        canonical={`https://alinavip.com/${slug}`}
        breadcrumbs={[
          { name: 'Home', url: 'https://alinavip.com' },
          { name: title, url: `https://alinavip.com/${slug}` },
        ]}
      />
        ...
        <div className="container-luxury max-w-4xl">
          ...
          <div className="mt-12 p-8 bg-gradient-to-r from-gold-50 to-amber-50 rounded-2xl border-2 border-gold-200 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://alinavip.com" target="_blank" className="border-2 border-gold-600 text-gold-600 hover:bg-gold-600 hover:text-white px-8 py-4 rounded-full font-bold text-lg transition-all">
                Visit ALINAVIP.com
              </a>
            </div>
          </div>
