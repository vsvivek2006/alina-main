    ...
    <LegalPage
      ...
      content={[
        ...
        },
        {
          ...
          paragraphs: [
            'Discretion is a core value of ALINA VIP. We understand that our clients value their privacy, and we are committed to maintaining complete confidentiality in all our interactions. Your personal information is never shared with our companions, other clients, or any third parties.',
            'Our companions are trained to maintain the highest standards of discretion. They do not store or share client information and conduct themselves with professionalism and confidentiality at all times.',
          ],
        },
        {
          heading: 'Your Rights',
    ...
    <LegalPage
      ...
      content={[
        ...
        },
        {
          ...
          paragraphs: [
            'ALINA VIP provides companionship services only. The companions listed on this website are independent individuals who provide social companionship. Any activities that may occur during or after an engagement are matters of personal choice between consenting adults.',
            'We do not control, direct, or influence the personal interactions between our clients and companions. Our role is limited to facilitating introductions and arranging bookings. We are not responsible for the conduct of our companions or clients during or after an engagement.',
          ],
        },
        {
    ...
    <LegalPage
      ...
      content={[
        ...
        },
        {
          ...
          paragraphs: [
            'ALINA VIP provides a platform for booking luxury companionship services. Our role is to facilitate introductions between clients and companions and to arrange bookings. The companions listed on our website are independent individuals who provide social companionship.',
            'We do not guarantee the availability of any specific companion at any given time. Companion availability is subject to change, and we reserve the right to substitute a companion if the originally requested companion is unavailable.',
          ],
        },
        {
        ...
        },
        {
          heading: 'Conduct',
          paragraphs: [
            'Clients are expected to treat our companions with respect and courtesy at all times. Any form of harassment, abuse, or disrespectful behavior will result in the immediate termination of the engagement and may result in a ban from using our services.',
            'Our companions reserve the right to decline or terminate an engagement if they feel uncomfortable or unsafe. We support our companions in exercising this right and will not penalize them for doing so.',
          ],
        },
        {
