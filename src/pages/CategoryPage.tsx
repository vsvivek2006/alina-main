...
export default function CategoryPage() {
  ...
  return (
    <>
      <SEO
        title={`${category.name} in Gurgaon | ALINA VIP Premium Companionship`}
