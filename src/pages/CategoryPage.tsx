...
import { ArrowRight, Phone, Star, Users, Crown, Sparkles, CheckCircle, MapPin, Clock, Shield, Award, Gem } from 'lucide-react';
  ...
  return (
    <>
      <SEO
        ...
        canonical={`https://alinavip.com/category/${category.slug}`}
        breadcrumbs={[
          { name: 'Home', url: 'https://alinavip.com' },
          { name: 'Services', url: 'https://alinavip.com/services' },
          { name: category.name, url: `https://alinavip.com/category/${category.slug}` },
        ]}
      />
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="max-w-4xl prose-luxury">
                ...
                <p className="text-gray-700 text-lg leading-relaxed mt-4">
                  ...
                  This ensures that every <Link to="/call-girls" className="text-gold-600 hover:underline">call girl</Link> 
                ...
                <p className="text-gray-700 text-lg leading-relaxed mt-4">
                  ...
                  functions, travel, and private engagements. They are discreet, professional, and 
                  committed to providing an exceptional <Link to="/services" className="text-gold-600 hover:underline">escort service</Link> experience.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-4">
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">100% genuine <Link to="/call-girls" className="text-gold-600 hover:underline">call girls</Link> with photo verification</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Complete privacy guaranteed for all <Link to="/escorts" className="text-gold-600 hover:underline">escorts</Link> bookings</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Book <Link to="/call-girls" className="text-gold-600 hover:underline">call girls</Link> anytime, day or night</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm"><Link to="/locations/cyber-city" className="text-gold-600 hover:underline">Cyber City</Link>, <Link to="/locations/mg-road" className="text-gold-600 hover:underline">MG Road</Link>, <Link to="/locations/golf-course-road" className="text-gold-600 hover:underline">Golf Course Road</Link> & more</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  <Link to="/locations/cyber-city" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                    Cyber City Call Girls
                  </Link>
                  <Link to="/locations/mg-road" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                    MG Road Escorts
                  </Link>
                  <Link to="/locations/golf-course-road" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                    Golf Course Road Escorts
                  </Link>
                  <Link to="/locations/dlf-phase-1" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                    DLF City Call Girls
                  </Link>
                  <Link to="/locations/sohna-road" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                    Sohna Road Escorts
                  </Link>
                  <Link to="/locations/sector-29" className="px-4 py-2 bg-gray-100 hover:bg-gold-100 text-gray-700 hover:text-gold-700 rounded-full text-sm transition-colors">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-gold-50 to-amber-50 rounded-2xl border-2 border-gold-200">
                  ...
                  <p className="text-center text-sm text-gray-500 mt-2">
                    Visit <a href="https://alinavip.com" target="_blank" className="text-gold-600 hover:underline font-semibold">ALINAVIP.com</a> for more
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-gold-50 to-amber-50 p-8 rounded-2xl text-center border-2 border-gold-200">
                ...
                <p className="text-gray-600 text-sm mt-2">Premium <Link to="/services" className="text-gold-600 hover:underline">escort service</Link> in Gurgaon</p>
              </div>
              ...
              <div className="bg-[#1a1a2e] p-6 rounded-2xl text-center">
                ...
                <a href="https://alinavip.com" target="_blank" className="block text-gold-400 hover:text-gold-300 text-sm mt-2">
                  Visit ALINAVIP.com
                </a>
              </div>
              ...
              <div className="bg-gold-50 p-6 rounded-2xl border border-gold-200 text-center">
                ...
                <p className="text-gray-600 text-sm">500+ verified client reviews for our <Link to="/services" className="text-gold-600 hover:underline">escort service</Link></p>
