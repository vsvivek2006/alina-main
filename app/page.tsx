    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#060812] via-[#0E1326] to-[#18102C]">
        ...
        <div className="container-luxury relative z-10 text-center pt-24 pb-16">
          ...
          >
            Premier verified <Link href="/services" className="text-gold-400 hover:underline font-medium">escorts service in Gurgaon</Link>. Connect with elite <Link href="/category/vip-call-girls" className="text-gold-400 hover:underline font-medium">VIP call girls</Link> with 100% verified photos and discreet 20–30 min 5-star hotel outcalls.
          </p>
